...
public class ChargingStationBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    public ChargingStationBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.CHARGING_STATION_BLOCK_ENTITY, pos, state);
    ...
    protected void writeNbt(NbtCompound nbt) {
        ...
        nbt.putInt("charging_station.progress", progress);
    }
    ...
    public void readNbt(NbtCompound nbt) {
        ...
        progress = nbt.getInt("charging_station.progress");
    }
    ...
    public Text getDisplayName() {
        return Text.translatable("charging_station.name");
    }
