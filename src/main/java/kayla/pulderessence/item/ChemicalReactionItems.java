...
public class ChemicalReactionItems {
    ...
    public static final Item NH3_BUCKET = registerCraftItem("hydrogen_nitride_bucket_reaction", new ProgressableItem(new FabricItemSettings(), ModBucketItems.AMMONIA_BUCKET, 2, ModBlocks.MYTHRIL_BLOCK));
